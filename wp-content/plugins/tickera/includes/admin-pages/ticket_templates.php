...
<div class="wrap tc_wrap">
	...
	<?php if ( !isset( $_GET[ 'action' ] ) || (isset( $_GET[ 'action' ] ) && $_GET[ 'action' ] == 'delete') || (isset( $_GET[ 'action' ] ) && $_GET[ 'action' ] == 'add_new' && isset( $_POST[ 'add_new_template' ] )) ) { ?>
		...
		<p>
			<?php if ( !$an ) { ?>
				<a class="tc_link" target="_blank" href="https://tickera.com/?wp"><?php _e( 'Create unlimited number of ticket templates, get premium support and unlock additional features.' ); ?></a>
			<?php }
			?>
		</p>
