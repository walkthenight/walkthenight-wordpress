...
if ( !class_exists( 'TC_Ticket_Template_Elements' ) ) {
	...
	class TC_Ticket_Template_Elements {
		...
		function get_colors( $label = 'Color', $field_name = 'color', $default_color = '#000000' ) {
			...
			<input type="text" class="tc-color-picker" name="<?php echo $this->element_name; ?>_<?php echo $field_name; ?>_post_meta" value="<?php echo isset( $this->template_metas[ $this->element_name . '_' . $field_name ] ) ? $this->template_metas[ $this->element_name . '_' . $field_name ] : $default_color; ?>" />
			<?php
		}
